...
#include "AddPrefixEditorMode.generated.h"
 ...
 */
UCLASS()
class UAddPrefixEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_AddPrefixEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UAddPrefixEditorMode();
	virtual ~UAddPrefixEditorMode();
