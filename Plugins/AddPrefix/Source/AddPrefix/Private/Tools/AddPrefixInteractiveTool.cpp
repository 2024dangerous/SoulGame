...
#include "AddPrefixInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UAddPrefixInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UAddPrefixInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UAddPrefixInteractiveTool* NewTool = NewObject<UAddPrefixInteractiveTool>(SceneState.ToolManager);
...
UAddPrefixInteractiveToolProperties::UAddPrefixInteractiveToolProperties()
{
...
void UAddPrefixInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UAddPrefixInteractiveTool::Setup()
{
	...
	Properties = NewObject<UAddPrefixInteractiveToolProperties>(this, "Measurement");
...
void UAddPrefixInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UAddPrefixInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UAddPrefixInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UAddPrefixInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UAddPrefixInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UAddPrefixInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UAddPrefixInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UAddPrefixInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UAddPrefixInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
