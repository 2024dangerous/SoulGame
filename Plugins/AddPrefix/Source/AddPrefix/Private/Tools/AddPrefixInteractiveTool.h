...
#include "AddPrefixInteractiveTool.generated.h"


/**
 * Builder for UAddPrefixInteractiveTool
 */
UCLASS()
class ADDPREFIX_API UAddPrefixInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UAddPrefixInteractiveTool
 */
UCLASS(Transient)
class ADDPREFIX_API UAddPrefixInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UAddPrefixInteractiveToolProperties();
...
/**
 * UAddPrefixInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ADDPREFIX_API UAddPrefixInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UAddPrefixInteractiveToolProperties> Properties;
